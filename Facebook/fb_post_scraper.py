...
class Post_Scraper:
    ...
    def login(self, username, password) -> None:
        ...
        time.sleep(2)
        email_ = self.driver.find_element(By.ID, "email")
        pass_ = self.driver.find_element(By.ID, "pass")
...
if __name__ == "__main__":
    posts_url = input(str("Enter keywords followed by a comma: "))
    keywords = posts_url.split(",")
    dates = {
        ...
        '2022': '%3D',
        '2021': '%3D',
        '2020': '%3D',
        '2019': '%3D',
        '2018': '%3D',
        '2017': '%3D',
        '2016': '%3D',
        '2015': '%3D',
        '2014': '%3D', }

    for date, filter in dates.items():
        print(f"Now scraping posts from {date}")
        final_url = "https://www.facebook.com/search/posts/?q=" + "%20".join(keywords) + "&filters=" + filter
        scraper = Post_Scraper(final_url)
        ...
        keyword_column = [' '.join(keywords)]
        date_column = [date]
        print(date_column)
        print(len(profile_names_list), len(descriptions_list), len(profile_urls_list), len(comments_list),
              len(who_commented_list))
        data = {"post_keyword": keyword_column * number_posts_max,
                "date posted": date_column * number_posts_max,
                "post_description": descriptions_list[:number_posts_max],
                "post_date": post_date_list[:number_posts_max],
                "comments": comments_list[:number_posts_max]}
